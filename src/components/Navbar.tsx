...
import {
    ...
    MobileNavToggle,
    MobileNavMenu,
} from "@/components/ui/style-navbar";
...
export function Navbar() {
    ...
    const handleDownloadResume = () => {
        ...
        const resumeUrl = "https://docs.google.com/document/d/1aTVTYnN9v-DBiIGcAtzP0Lzj_Cuzk7ph/edit?usp=drive_link&ouid=100101563820177392474&rtpof=true&sd=true"
    ...
    return (
        <main className="fixed w-full z-20">
            <Nav>
                ...
                <NavBody>
                    {/* <NavbarLogo /> */}
                    <span className="font-bold   text-2xl  font-sans"> </span>
